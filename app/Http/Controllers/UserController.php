...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('users.index', compact('members', 'ranks'));
    }
    ...
    public function lists()
    {
        ...
        return view('users.list', compact('members', 'ranks'));
    }
    ...
    {
        return View('users.register-member');
    }
    ...
    public function updateRank($id)
    {
        ...
        return view('users.update-rank', compact('user', 'ranks'));
    }
    ...
    public function showMykadStatus($id)
    {
        ...
        if(!is_null($profile))
        {
            return view('users.show-mykad-status', compact('profile'));
        }
