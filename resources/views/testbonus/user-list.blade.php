                        ...
                        <tr>
                            ...
                            <td>
                                @if(Auth::guard('admin')->user() !== null && Auth::guard('admin')->user()->hasRole('Administrator'))
                                    <!-- <a class="btn btn-primary" href="{{ url('testbonus/personal-rebate/'.$member->id) }}">Personal Rebate</a> -->
                                    <a class="btn btn-primary" href="{{ url('testbonus/retail-profit/'.$member->id)}}">
                                    	Retail Profit
                                	</a>
                                	<a class="btn btn-primary" href="{{ url('testbonus/override-retail-profit/'.$member->id)}}">
                                		Override Retail Profit
                                	</a>
