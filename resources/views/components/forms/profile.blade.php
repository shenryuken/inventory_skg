...
@if(isset($profile) && $profile->profileable->type == 'personal')
...
@elseif(isset($profile) && $profile->profileable->type == 'business')
<div class="panel-body">
	<div class="panel-body">
		<h3 class="panel-title"><strong>Company Info</strong></h3>
	</div>
	<div class="form-group">
...
@elseif(isset($profile) && Auth::guard('admin')->check() )
<div class="panel-body">
	<div class="panel-body">
		<h3 class="panel-title"><strong>Personal Info</strong></h3>
	</div>
...
@elseif(!isset($profile) && (Auth::guard('web')->check() && Auth::user()->type == 'personal'))
<div class="panel-body">
	<div class="panel-body">
		<h3 class="panel-title"><strong>Personal Info</strong></h3>
	</div>
	<div class="form-group">
		<label for="full_name" class="col-sm-2 control-label" >Full Name</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" id="full_name" name="full_name" placeholder="Your Full Name" style="text-transform: capitalize" value="{{ old('full_name')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="id_type" class="col-sm-2 control-label">ID Type</label>
		...
		<label for="icno" class="col-sm-2 control-label">MyKad/Passport No.</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="id_no" id="id_no" placeholder="Your Mykad/Passport No" value="{{ old('id_no')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="street" class="col-sm-2 control-label">Street</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" name="street" id="street" placeholder="Street" style="text-transform: capitalize" value="{{ old('street')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="street2" class="col-sm-2 control-label">Street 2</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" name="street2" id="street2" placeholder="Street 2" style="text-transform: capitalize" value="{{ old('street2')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="postcode" class="col-sm-2 control-label">Postcode</label>
		...
		<label for="city" class="col-sm-2 control-label">City</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="city" id="city" placeholder="City" style="text-transform: capitalize" value="{{ old('city')}}">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="state" class="col-sm-2 control-label">State</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="state" id="state" placeholder="State" style="text-transform: capitalize" value="{{ old('state')}}">
		</div>
		<label class="col-sm-2 control-label">Country</label>
		<div class="col-sm-2">
			<select name="country" class="form-control" autocomplete="off">
	...
	<div class="form-group">
		<label for="contact_no" class="col-sm-2 control-label">Mobile No</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="contact_no" id="contact_no" placeholder="Mobile No" value="{{ old('contact_no')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="contact_no2" class="col-sm-2 control-label">Tel No(home)</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="contact_no2" id="contact_no2" placeholder="Tel No" value="{{old('contact_no2')}}">
		</div>
	</div>
	<!-- Beneficiary Info -->
...
@elseif(!isset($profile) && (Auth::guard('web')->check() && Auth::user()->type == 'business'))
<div class="panel-body">
	<div class="panel-body">
		<h3 class="panel-title"><strong>Company Info</strong></h3>
	</div>
	<div class="form-group">
		<label for="company_name" class="col-sm-2 control-label" >Company Name</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" id="company_name" name="company_name" placeholder="Your Full Name" style="text-transform: capitalize" value="{{ old('company_name')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="company_registration_no" class="col-sm-2 control-label">Company Registration No.</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" name="company_registration_no" id="company_registration_no" placeholder="Your Mykad/Passport No" value="{{ old('company_registration_no')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="street" class="col-sm-2 control-label">Street</label>
	...
	<div class="form-group">
		<label for="contact_no" class="col-sm-2 control-label">Office No. (1)</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="contact_no" id="contact_no" placeholder="Office No" value="{{ old('contact_no')}}">
		</div>
		<label for="contact_no2" class="col-sm-2 control-label">Office No. (2)</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="contact_no2" id="contact_no2" placeholder="Office No" value="{{ old('contact_no2')}}">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="fax_no" class="col-sm-2 control-label">Fax No.</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="fax_no" id="fax_no" placeholder="Fax No" value="{{ old('fax_no')}}">
		</div>
	</div>
	<div class="panel-body">
		<h3 class="panel-title"><strong>Share Holder Info</strong></h3>
	...
	<div class="form-group">
		<label for="share_holder_name" class="col-sm-2 control-label">Share Holder Name</label>
		<div class="col-sm-4">
			<input type="text" class="form-control" name="share_holder_name" id="share_holder_name" placeholder="Your Mykad/Passport No" value="{{ old('share_holder_name')}}">
		</div>
	</div>
	<div class="form-group personal">
		<label class="col-sm-2 control-label">Date Of Birth *</label>
		<div class="col-sm-2">
			<input class="form-control" type="date" id="datepicker" name="share_holder_dob" value="{{ old('share_holder_dob')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="share_holder_gender" class="col-sm-2 control-label">Gender</label>
	...
	<div class="form-group">
		...
		<label for="share_holder_id_no" class="col-sm-2 control-label">Share Holder Id No.</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="share_holder_id_no" id="share_holder_id_no" placeholder="Your Mykad/Passport No" value="{{old('share_holder_id_no')}}">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="share_holder_mobile_no" class="col-sm-2 control-label">Share Holder Mobile No.</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="share_holder_mobile_no" id="share_holder_id_no" placeholder="Your Mobile No" value="{{ old('share_holder_mobile_no')}}">
		</div>
	</div>
	<div class="form-group">
		<label for="share_holder_email" class="col-sm-2 control-label">Share Holder Email</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="share_holder_email" id="share_holder_id_no" placeholder="Your Email" value="{{ old('share_holder_email')}}">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">Security Code</label>
