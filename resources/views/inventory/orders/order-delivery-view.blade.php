	...
	<div class="col-md-6">
        ...
        <div class="panel panel-success push-up-20">
            ...
            <div id="printed_area" class="panel-body panel-body-pricing">  
                    <div class="row">
                            <img class="pull-right" src="data:image/png;base64,{{ DNS1D::getBarcodePNG(isset($delivery->delivery_number) ? str_replace("DO","",$delivery->delivery_number) : "", "CODABAR")  }}" alt="barcode"   />
                        </div>             
