			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="actions pull-right">
						...
						<a href="{{ url('inventory/product/package_edit/' . $id) }}" class="btn btn-default  btn-sm btn-circle" title="Edit {{ $code .' ('. $name .')' }}" >
				...
				<div class="panel-body form-horizontal">
					...
					<div class="row">
						<br /> &nbsp;
						<div class="col-md-12">
							<h3> Gallery <a href="{{ url('inventory/product/package_edit/' . $id . '/1') }}" class="btn btn-default  pull-right btn-sm btn-circle" title="Edit Gallery {{ $code .' ('. $description .')' }}" >
